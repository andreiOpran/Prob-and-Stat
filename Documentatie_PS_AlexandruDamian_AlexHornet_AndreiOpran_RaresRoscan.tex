...
% \title{\textbf{Proiect la Probabilit\u{a}\t{i} \s{i} Statistic\u{a}}}
% \author{
%   Alexandru Damian, Alex Horne\t{t}, Andrei Opran, Rare\s{ }Ro\s{c}can\\
%   Grupa 242\\
%   Universitatea din Bucure\s{t}i\\
%   Facultatea de Matematic\u{a} \s{i} Informatic\u{a}\\
%   Profesor de curs: Lect.dr. Alexandru Am\u{a}rioarei\\
%   Laborant\u{a}: Andriciuc Alexandra
% }


\lstset{ % Setări pentru codul R
  language=R,
